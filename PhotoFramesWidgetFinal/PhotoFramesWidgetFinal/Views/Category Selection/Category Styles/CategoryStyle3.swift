...
struct CategoryStyle3_Previews: PreviewProvider {
    static var previews: some View {
        CategoryStyle3(content: [AnyView(Color.red), AnyView(Color.blue), AnyView(Color.green), AnyView(Color.orange), AnyView(Color.purple), AnyView(Color.pink), AnyView(Color.orange), AnyView(Color.yellow)])
            .frame(width: 300, height: 560)
    }
}
