...
struct MFrameRainbowInverted: View {
...
struct MFrameRainbowInverted_Previews: PreviewProvider {
    static var previews: some View {
        MFrameRainbowInverted(image: UIImage(color: UIColor.init(white: 1, alpha: 1))!, transform: CGSize(width: 0, height: 0), scaleFactor: 1.0, lineWidth: 15)
