            ...
            if preview {
                ZStack {
                    ...
                    VStack(spacing: geo.size.width / 30) {
                        CroppedImage(image: images[0], transform: transforms[0], scaleFactor: scaleFactors[0], geoSize: CGSize(width: geo.size.width - (geo.size.width / 15), height: geo.size.height / 2 - (geo.size.width / 20)))
