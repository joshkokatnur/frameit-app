            ...
            if preview {
                ZStack {
                    ...
                    HStack(spacing: geo.size.width / 30) {
                        ...
                        CroppedImage(image: images[2], transform: transforms[2], scaleFactor: scaleFactors[2], geoSize: CGSize(width: geo.size.width / 2 - (geo.size.width / 20), height: geo.size.height - (geo.size.width / 15)))
