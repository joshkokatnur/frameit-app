...
struct CustomColorPromotion: View {
    ...
    var body: some View {
        VStack {
            ...
            if device == .pad {
                iPadMockup(imageName: colorScheme == .light ? (isPortrait ? "promo1_Vipad_light" : "promo1_Hipad_light") : (isPortrait ? "promo1_Vipad_dark" : "promo1_Hipad_dark"),
                ...
                PhoneMockup(imageName: colorScheme == .light ? "promo1_light" : "promo1_dark",
...
struct CustomColorPromotion_Previews: PreviewProvider {
    static var previews: some View {
        Group {
            Text("")
                .sheet(isPresented: .constant(true)) {
                    CustomColorPromotion(parentGeoSize: CGSize(width: 375, height: 734), product: MockSKProduct(), rotationAngle: 3, presentSheet: .constant(true), storeManager: StoreManager())
